...
html {
    ...
    <div class="col-tab">
      <ul class="tabBut cu-li">
        <li id="tab_swf_1" class="on"  onclick="SwapTab('swf','on','',4,1);">上传图片</li>
      ...
      <form method="post" action="">
        ...
        请输入网络地址
        <div class="bk3"></div>
        <input id="infilename" type="text" name="info[url]" class="input-text" value="" style="width:350px;"  onblur="addonlinefile(this)">
        <div class="bk10"></div>
        请输入图片名称
         <div class="bk3"></div>
        <input id="infilename" type="text" name="info[title]" class="input-text" value=""  style="width:350px;"  onblur="addonlinefile(this)">
        <div class="bk10"></div>
        请选择生成缩略图规格
        <div class="bk3"></div>
              <label>
              ...
              <label>
                ...
                <?php echo $v;?>*<?php echo $v;?></label>
              <?php }?>  
        <input type="submit" class="hidden" id="dosubmit" name="dosubmit" value="提交"/>
        </form>
      </div>
...
function retitle(obj)
{
	...
	$.post("<?php echo U('Plug/swfuploadRetitle');?>",{'id':id,'title':title},function (data){
		if(data!='')
		{
