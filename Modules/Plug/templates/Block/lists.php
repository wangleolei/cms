		...
		<tbody>
			<tr>
				<td><div class="explain-col">
                                        分组名称：
						<input name="group" type="text" value="<?php echo $_GET['group'];?>" class="input-text search-text">
...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            ...
            <th  align="left" width="350">名称</th>
             <th  align="left" width="350">分组名称</th>
			<th width="100" align="left">状态</th>
			<th align="center"></th> 
			<th width="170" align="center">管理操作</th>
            </tr>
        </thead>
	<tbody>
	<?php foreach($list as $v){?>
		<tr>
			...
			<td align="center"></td>
			<td align="center"> <a href="javascript:void(0)" onClick="edit('<?php echo $v['id'];?>','修改当前广告块')">修改</a>  <?php if($this->check_url_prev('delete')){?>| <a href="<?php echo U('Plug/Block/delete/id/'.$v['id']);?>" onClick="return myconfirm('你确定删除这个广告块吗？');">删除</a><?php }?> | <a href="<?php echo U('Plug/Block/editBlock/id/'.$v['id']);?>" target="_blank">编辑广告块</a></td>
		</tr>
	<?php }?>
	</tbody>
	</table>
