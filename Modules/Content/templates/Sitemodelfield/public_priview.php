...
<div class="crumbs">模型预览&gt;<?php echo $r['name'];?></div>
<div class="col-right">
    	<div class="col-1">
...
<div class="fixed-bottom">
    ...
    <div class="button"><input value="保存并继续发布" type="submit" name="dosubmit_continue" class="cu" style="width:130px;" title="Alt+X"></div>
...
function crert_str(arr)
{
	if(arr.length>=1)
	{
		$("#thumb_preview").attr('src',arr[0].src);
		$("#thumb").val(arr[0].src);	
	}
}
<!--
