...
<table width="100%" class="table_form contentWrap">
      ...
      <tr>
        <th width="120">排序：</th>
        <td><input type="text" name="info[listorder]" id="listorder" class="input-text" value="0"></td>
      </tr>
      <tr>
        <th width="120">外部链接：</th>
        <td><input type="text" name="info[url]" id="outlink" size="30" class="input-text" value=""></td>
      </tr>       	  
      <tr>
        ...
        <td>
			<?php foreach($this->category_type as $ko=>$vo){?>
        		<label>
        			<input type="checkbox" name="info[type][]" value="<?php echo $ko;?>">
        			<?php echo $vo;?></label>
			<?php }?>		
        		</td>
      </tr>      
      <tr>
        ...
        <td>
            ...
            <label>
                <input type="checkbox" name="info[modelids][]" id="modelids" value="<?php echo $val['modelid'];?>">
	  ...
	  <tr>
        <th>可见：</th>
        <td><label><input type="radio" name="info[display]" value="1" checked="checked"> 显示</label><label><input type="radio" name="info[display]" value="0"> 隐藏</label></td>
      </tr>        
	  <tr>
        <th>状态：</th>
        <td><label><input type="radio" name="info[status]" value="1" checked="checked"> 启用</label><label><input type="radio" name="info[status]" value="0"> 禁用</label></td>
      </tr>	 	  		  	  
</table>  
</fieldset>
...
<table width="100%" class="table_form contentWrap">
      <tr>
        ...
        <td><input type="text" name="info[template1]" id="template1" class="input-text" value=""></td>
      </tr> 
      <tr>
        <th width="120">PC端内容页模版：</th>
        <td><input type="text" name="info[template2]" id="template2" class="input-text" value=""></td>
      </tr>
      <tr>
        <th width="120">移动端内容页模版：</th>
        <td><input type="text" name="info[template3]" id="template3" class="input-text" value=""></td>
      </tr> 
      <tr>
        <th width="120">移动端内容页模版：</th>
        <td><input type="text" name="info[template4]" id="template4" class="input-text" value=""></td>
      </tr> 
 </table>   
</fieldset>  
<!--table_form_off-->
