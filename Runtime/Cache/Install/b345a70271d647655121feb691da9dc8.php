...
<body>
	...
	<div class="version"><?php echo (C("version")); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="<?php echo U('step4');?>" method="post">
				...
				<div class="server">
					<table width="100%">
						...
						<tr>
							...
							<td><input type="text" name="dbname" id="dbname" value="thinkercms" class="input"></td>
							<td><div id="js-install-tip-dbname"></div></td>
						</tr>
						<tr>
							<td class="text-left">数据库表前缀：</td>
							<td><input type="text" name="dbprefix" id="dbprefix" value="fc_" class="input"></td>
							<td>
								<div id="js-install-tip-dbprefix">
									<span class="gray">建议使用默认，同一数据库安装多个ThinkerCMS时需修改</span>
								</div>
							</td>
						</tr>
					</table>
					<table width="100%">
						...
						<tr>
							...
							<td><input type="text" name="sitename" value="ThinkerCMS内容管理系统" class="input" readonly></td>
							<td><div id="js-install-tip-sitename"></div></td>
						</tr>
						<tr>
							<td class="text-left">网站域名：</td>
							<td><input type="text" name="siteurl" value="<?php echo sp_get_host();?>/" class="input" autoComplete="off" readonly></td>
							<td>
						...
						<tr>
							...
							<td><input readonly type="text" name="sitekeywords" value="ThinkerCMS,ThinkerCMS内容管理系统,thinkphp内容管理系统" class="input" autoComplete="off"></td>
							<td><div id="js-install-tip-sitekeywords"></div></td>
						</tr>
						<tr>
							<td class="text-left">描述：</td>
							<td><input readonly type="text" name="siteinfo" class="input" value="ThinkerCMS是ThinkerPHP旗下的一款专门针对小型网站的内容管理系统，其特点在于可快速进行二次开发。"></td>
				...
				<div class="bottom text-center">
					<a href="<?php echo U('step2');?>" class="btn btn-primary">上一步</a>
		...
		<script>
			...
			$(function() {
				...
				var focus_tips = {
					...
					dbpw : '',
					dbname : '',
					dbprefix : '建议使用默认，同一数据库安装多个ThinkerCMS时需修改',
				...
				install_form.validate({
					...
					rules : {
						...
						manager_pwd : {required : true,minlength:6},
					...
					messages : {
						...
						manager_pwd : {minlength : '密码至少为六位字符'},
