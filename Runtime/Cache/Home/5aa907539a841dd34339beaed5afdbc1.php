          ...
          <div class="wk_bm_wc cl">
            <ul>
              ...
              <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cl">
              	<?php if($vo['thumb']): ?><div class="atc b_img"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><img src="<?php echo thumb_url($vo['thumb'],400,400);?>" alt="<?php echo ($vo["title"]); ?>" class="tn" /></a></div><?php endif; ?>
                ...
                <span class="xg1"> <span class="xg1">时间: <?php echo date('Y-m-d H:i',$vo['inputtime']);?></span> </span> </li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          </div>
          <!--[diy=listloopbottom]-->
