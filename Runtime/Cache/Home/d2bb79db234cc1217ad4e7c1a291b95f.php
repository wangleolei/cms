...
<div class="wk_ymbg">
  <div id="wp" class="wp">
    ...
    <div id="ct" class="ct2 wp cl">
      <div class="mn">
        <div class="wk_c_right_name">
          ...
          <div class="wk_c_right_name_r">
            <ul>
              ...
              <li> <span>您现在的位置：</span> <span><a href="<?php echo C('site_host');?>/">首页</a></span> <span>→</span> <span><?php echo ($name); ?></span> </li>
            </ul>
          </div>
        </div>
        <!--[diy=listcontenttop]-->
        ...
        <div class="bm">
          <div class="wk_bm_wc cl">
            <ul class="wk_su">
              <?php $val=$d_content->getContentList(array('modelid'=>$modelid,'catid'=>$catid,'num'=>12,'ispage'=>1)); ?>
              <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cl">
                ...
                <p class="wk_bm_sm"><?php echo ($vo["description"]); ?> ...</p>
                <span class="xg1"> 分类:
                <label><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" class="xi2"><?php echo ($vo["catname"]); ?></a></label>
                &nbsp;&nbsp; <span class="xg1">时间: <?php echo date('Y-m-d H:i',$vo['inputtime']);?></span> </span> </li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          </div>
          <!--[diy=listloopbottom]-->
      ...
      <div class="sd pph">
        <div class="wk_c_left_t"> <span class="wk_c_left_t1"><?php echo ($name); ?></span> <span class="wk_c_left_t2">Category</span> </div>
        <div class="wk_c_left_cnt">
          <ul>
            <?php $cats=$d_category->getChildren($catid); ?>
            <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="wk_menu1_cur"><a href="<?php echo UN('lists',array('catid'=>$vo['id']));?>" title="<?php echo ($vo["name"]); ?>" ><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
        <div class="clear"></div>
        <!--[diy=wk_zcyl1]-->
