...
<div class="wk_ymbg">
  <div id="wp" class="wp">
    ...
    <div id="ct" class="ct2 wp cl">
      <div class="mn">
        ...
        <div class="wk_content_right_m">
          <div class="wk_tidings_m">
            ...
            <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="wk_tidings_main" <?php if(!$vo['thumb']): ?>style="width:100%;"<?php endif; ?>>
              <?php if($vo['thumb']): ?><div class="wk_tidings_img"> <a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" target="_blank" title="<?php echo ($vo["title"]); ?>"><img src="<?php echo thumb_url($vo['thumb'],400,400);?>" alt="<?php echo ($vo["title"]); ?>"/></a> </div><?php endif; ?>
              <div class="wk_tidings_main_name" <?php if(!$vo['thumb']): ?>style="width:100%;"<?php endif; ?>> <span class="wk_tidings_main_name2"><a target="_blank" title="<?php echo ($vo["title"]); ?>" href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></span> </div>
              <div class="wk_tidings_main_cnt" <?php if(!$vo['thumb']): ?>style="float:left;"<?php endif; ?>> <span class="wk_tidings_main_cnt2"><?php echo ($vo["description"]); ?>...</span> </div>
              <div class="wk_tidings_main_more" <?php if(!$vo['thumb']): ?>style="float:left;"<?php endif; ?>><a target="_blank" title="more" href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>">more>></a> </div>
      ...
      <div class="sd pph">
        <div class="wk_c_left_t"> <span class="wk_c_left_t1"><?php echo ($pname); ?></span> <span class="wk_c_left_t2">Report</span> </div>
        <div class="wk_c_left_cnt">
          <ul>
            <?php $cats=$d_category->getChildren($parentid); ?>
            <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="wk_menu1_cur"><a href="<?php echo UN('lists',array('catid'=>$vo['id']));?>" title="<?php echo ($vo["name"]); ?>" <?php if($catid == $vo['id']): ?>class="a"<?php endif; ?>><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
        <div class="clear"></div>
        <!--[diy=wk_zcyl1]-->
        ...
        <div class="wk_left_contdiv"> <span><strong>地 址：</strong><?php echo ($siteinfo["address"]); ?></span> <span><strong>咨询热线：</strong><?php echo ($siteinfo["phone"]); ?></span> <span><strong>服务投拆：</strong><?php echo ($siteinfo["phone1"]); ?></span> <span><strong>传 真：</strong><?php echo ($siteinfo["fax"]); ?></span> <span><strong>邮 箱：</strong><a href="mailto:<?php echo ($siteinfo["email"]); ?>"><?php echo ($siteinfo["email"]); ?></a></span> </div>
        <div class="clear"></div>
        <div class="clear"></div>
        <!--[diy=wk_zcyl2]-->
