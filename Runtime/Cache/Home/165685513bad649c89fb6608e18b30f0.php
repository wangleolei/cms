      ...
      <div class="mn">
        ...
        <div class="wk_problem">
          <ul>
            ...
            <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li >
              <div class="wk_pd"> <span> <?php echo date('Y-m-d',$vo['inputtime']);?> </span>
                <h2><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" target="_blank" title="<?php echo ($vo["title"]); ?>" ><?php echo ($vo["title"]); ?></a> </h2>
                <span><?php echo ($vo["description"]); ?> ...</span> </div>
