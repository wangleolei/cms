    ...
    <div id="ct" class="ct2 wp cl">
      ...
      <div class="xld">
        ...
        <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl class="wk_rele cl">
          <dd class="wk_asl_01"> <em class="wk_tw01"><em class="wk_tw02"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" target="_blank" style="background-image:url(<?php echo thumb_url($vo['thumb'],400,400);?>)"><?php echo ($vo["title"]); ?></a></em></em> </dd>
