    ...
    <div id="ct" class="ct2 wp cl">
      <div class="mn">
        ...
        <div class="wk_content_right_m">
          <div class="wk_pro_m">
          	<?php $val=$d_content->getContentList(array('modelid'=>$modelid,'catid'=>$catid,'num'=>9,'ispage'=>1)); ?>
            <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="wk_pro_main" >
              <div class="wk_pro_img"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" target="_blank"><img src="<?php echo thumb_url($vo['thumb'],400,400);?>" alt="<?php echo ($vo["title"]); ?>" /></a></div>
              <div class="wk_pro_main_name"> <span class="wk_pro_main_name2"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></span> </div>
              <div class="wk_pro_main_cnt"> <span class="wk_pro_main_cnt2"><?php echo ($vo["description"]); ?> ...</span> </div>
              <div class="wk_pro_main_more"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="了解更多" target="_blank">了解更多</a> </div>
      ...
      <div class="sd pph">
        <div class="wk_c_left_t"> <span class="wk_c_left_t1"><?php echo ($pname); ?></span> <span class="wk_c_left_t2">Category</span> </div>
