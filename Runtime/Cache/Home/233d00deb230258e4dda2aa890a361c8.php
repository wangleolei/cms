    ...
    <div id="ct" class="ct2 wp cl">
      <div class="mn">
        ...
        <div class="wk_double cl">
          <ul>
          	<?php $val=$d_content->getContentList(array('modelid'=>$modelid,'catid'=>$catid,'num'=>10,'ispage'=>1)); ?>
            <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cl" >
              <?php if($vo['thumb']): ?><div class="atc b_img"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><img src="<?php echo thumb_url($vo['thumb'],135,135);?>" alt="<?php echo ($vo["title"]); ?>" width="140" height="130" class="tn" /></a></div><?php endif; ?>
              <h2><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" target="_blank" class="xi2" title="<?php echo ($vo["title"]); ?>" ><?php echo ($vo["title"]); ?></a> </h2>
              <span class="xg1"> <span>时间: <?php echo date('Y-m-d H:i',$vo['inputtime']);?></span> </span>
              <p class="bm_sm"><?php echo ($vo["description"]); ?>...</p>
