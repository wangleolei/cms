...
<div class="wk_head_banner">
  <div class="wk_portalhead_bn12">
    <div class="wk_portalhead_bg">
      ...
      <div class="clear"></div>
      <ul>
        <li><a href="<?php echo UN('lists',array('catid'=>$catid));?>" title="<?php echo ($name); ?>" class="a">全部</a></li>
        <?php $cats=$d_category->getChildren($catid); ?>
        <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo UN('lists',array('catid'=>$vo['id']));?>" title="电商零售" ><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
    <div class="clear"></div>
  </div>
    ...
    <div id="ct" class="ct2 wp cl">
      ...
      <div class="wk_product" id="photo">
        <ul>
          ...
          <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list" > <a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" target="_blank"> <img src="<?php echo thumb_url($vo['thumb'],400,400);?>" alt="<?php echo ($vo["title"]); ?>"/>
            <dd class="pt_amt" style="display: block;">
              <h2><?php echo ($vo["title"]); ?></h2>
              <div class="wk_mt"><span>时间:<?php echo date('Y-m-d H:i',$vo['inputtime']);?></span></div>
            </dd>
