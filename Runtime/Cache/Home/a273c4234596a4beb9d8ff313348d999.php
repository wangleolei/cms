      ...
      <div class="mn">
        ...
        <div class="wk_content_right_m">
          <div class="wk_case_m">
            ...
            <?php if(is_array($val["list"])): $i = 0; $__LIST__ = $val["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="wk_case_main" >
              <div class="wk_case_img"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" target="_blank"><img src="<?php echo thumb_url($vo['thumb'],400,400);?>" alt="<?php echo ($vo["title"]); ?>" /></a></div>
              <div class="wk_case_main_name"> <span class="wk_case_main_name2"><a href="<?php echo UN('detail',array('catid'=>$vo['catid'],'id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></span> </div>
